...
@section('body')
    <main>
        ...
        <section id="societies">
            ...
            <p>Vos sociétés sont accécibles sur <a href="{{ route('account') }}">la page de votre compte</a>.</p>
        </section>
        <section id="clients">
            <h2>Vos clients</h2>
        ...
        <section id="info">
            ...
            <p>Vous pouvez retrouver le code source de ce projet sur <a href="https://github.com/johan-jnn/factulandar" target="_blank">le repo GitHub</a>.</p>
        </section>
    </main>
@endsection
